...
import io.github.some_example_name.healthyeating.factory.FoodSpawnSpec;
import io.github.some_example_name.healthyeating.factory.SpawnHelper;
...
public class FoodStageScene extends Scene {
    ...
    private void spawnFoodBatch(FoodType type, int count, StageProfile profile) {
        for (int i = 0; i < count; i++) {
            String texturePath = contentFactory.resolveTexturePath(type);
